...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <h3 class="border border-0 pe-3">Edit Employee Leave</h3>
        </div>

        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form action="{{ route('update.employee.leave',$editData->id) }}" method="POST" class="row g-3">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="start_date" value="{{ $editData->start_date }}" placeholder="Salary Amount" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="end_date" value="{{ $editData->end_date }}" class="form-control">
                        </div>
