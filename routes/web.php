...
// User Pofile and Change Password
...
Route::prefix('reports')->group(function(){
    ...
    Route::get('markheet/generate/view', [MarkSheetController::class, 'MarkSheetView'])->name('markheet.generate.view');
    Route::get('markheet/generate/get', [MarkSheetController::class, 'MarkSheetGet'])->name('report.marksheet.get');
