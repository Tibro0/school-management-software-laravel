...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Student Marks Edit</h4>
                <hr class="mt-3 mb-3">
                ...
                @csrf
                    <div class="row">
                      ...
                      <div class="d-none mt-4" id="marks-entry">
                        <table id="example" class="table mb-0 mt-4 table-striped align-middle " >
                            <thead>
                                <tr>
                        ...
                        <input type="submit" value="Update" class="btn btn-success px-5 mt-4">
                      </div>
