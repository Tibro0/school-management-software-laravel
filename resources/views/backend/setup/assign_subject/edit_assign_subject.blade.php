...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <h3 class="border border-0 pe-3">Add Assign Subject</h3>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="p-4 border rounded">
                    ...
                    <form action="{{ route('update.assign.subject',$editData[0]->class_id) }}" method="POST" class="row g-3">
                        @csrf
                        ...
                        @foreach ($editData as $edit)
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="full_mark[]" value="{{ $edit->full_mark }}" placeholder="Full Mark" class="form-control">
                            </div>

                            <div class="col-md-2">
                                <label class="form-label">Pass Mark</label>
                                <input type="text" name="pass_mark[]" value="{{ $edit->pass_mark }}" placeholder="Pass Mark" class="form-control">
                            </div>

                            <div class="col-md-2">
                                <label class="form-label">Subjective Mark</label>
                                <input type="text" name="subjective_mark[]" value="{{ $edit->subjective_mark }}" placeholder="Subjective Mark" class="form-control">
                            </div>
